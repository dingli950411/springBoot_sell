                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <#list orderDTOPage.content as orderDTO>
                            <tr>
                                ...
                                <td>
                                    ${orderDTO.getOrderStatusEnum().getDesc()}
                                </td>
                                <td>
                                    ${orderDTO.getPayStatusEnum().getDesc()}
                                </td>
                                <td>
                                    ${orderDTO.createTime}
                                </td>
                                ...
                                <td>
                                    <#if orderDTO.getOrderStatusEnum().getDesc()=="新订单">
...
<script>
    ...
    if('WebSocket' in window){
        websocket = new WebSocket('ws://lili.natapp1.cc/sell/webSocket');
    }else{
